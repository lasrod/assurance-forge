...
TRANSLATIONS = {
    ...
    "Pattern": "パターン",
    "Add Pattern...": "パターンを追加...",
    "Create Pattern": "パターンを作成",
    "Pattern name": "パターン名",
    "Pattern identifier": "パターン識別子",
    "Pattern: {0}": "パターン: {0}",
    "Argument pattern definition": "アーギュメントパターン定義",
    "Mark as Uninstantiated": "未インスタンス化としてマーク",
    "Mark as Undeveloped": "未展開としてマーク",
    "Pattern Abstraction": "パターン抽象化",
    "None": "なし",
    "Optional": "オプション",
    "Multiplicity": "多重度",
    "Cardinality": "多重度値",
    "Apply": "適用",
    "Examples: 1..*, 0..1, 2..5, n": "例: 1..*, 0..1, 2..5, n",
    "Create Choice Group": "選択グループを作成",
    "Remove Choice Group": "選択グループを削除",
    "Choice Group": "選択グループ",
    "Edit Term": "用語を編集",
    "Create Term": "用語を作成",
