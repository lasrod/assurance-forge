...
TRANSLATIONS = {
    ...
    "OK": "OK",
    "Create Project from Existing SACM": "既存の SACM からプロジェクトを作成",
    "Create Project from Existing SACM...": "既存の SACM からプロジェクトを作成...",
    "Import SACM File": "SACM ファイルをインポート",
    "Import SACM File...": "SACM ファイルをインポート...",
    "Import": "インポート",
    "SACM file": "SACM ファイル",
    ...
    "Start a project from a SACM XML assurance case you already have": "手元にある SACM XML 保証ケースからプロジェクトを開始します",
    ...
    "Add ACP": "ACP を追加",
    "Away Goal": "他モジュールの目標",
    "Away Assumption": "他モジュールの仮定",
    "Away Justification": "他モジュールの正当化",
    "No away element selected.": "他モジュールの要素が選択されていません。",
    ...
    "An away element cannot be added while a draft is open.": "ドラフトを開いている間は他モジュールの要素を追加できません。",
    "{0} cites {1} as an assumption made in another module, but nothing in this case has that id. The argument rests on an assumption nobody states.": "{0} は {1} を他モジュールで置かれた仮定として参照していますが、その ID はこのケースに存在しません。論証が、誰も述べていない仮定に依拠しています。",
    "{0} cites {1} as a justification given in another module, but nothing in this case has that id. The argument rests on a justification nobody gives.": "{0} は {1} を他モジュールで示された正当化として参照していますが、その ID はこのケースに存在しません。論証が、誰も示していない正当化に依拠しています。",
    ...
    "{0} rows share one support relationship but were assessed differently; resolve them in the register before moving them into SACM.": "{0} 件の行が 1 つのサポート関係を共有していますが、評価が異なります。SACM に移動する前にレジスタで解決してください。",
    ...
    '{0} already exists and is not an Assurance Forge project.': '{0} は既に存在しますが、Assurance Forge のプロジェクトではありません。',
    'No location is recorded.': '場所が記録されていません。',
    'File was not found: {0}': 'ファイルが見つかりません: {0}',
    'Could not open: {0}': '開けませんでした: {0}',
    'Could not open File Explorer for: {0}': 'エクスプローラーで開けませんでした: {0}',
    'Opening File Explorer is not supported on this platform.': 'このプラットフォームではエクスプローラーで開く機能はサポートされていません。',
    ...
    'AI review completed, but its suggested changes were not added because the elements it reviewed changed while it was running. Run the review again.': 'AI レビューは完了しましたが、実行中にレビュー対象の要素が変更されたため、提案された変更は追加されませんでした。レビューを再実行してください。',
    'AI review data packages could not be collected.': 'AI レビューのデータパッケージを収集できませんでした。',
    'AI review incomplete: {0}': 'AI レビューが不完全です: {0}',
    'AI review payload could not be created.': 'AI レビューのペイロードを作成できませんでした。',
    'AI review proposed a change that could not be read: {0}': 'AI レビューが読み取れない変更を提案しました: {0}',
    'AI review request is ready in the AI Debug panel.': 'AI レビューのリクエストを AI デバッグパネルで準備しました。',
    'AI review request sent.': 'AI レビューのリクエストを送信しました。',
    'AI review response could not be validated.': 'AI レビューの応答を検証できませんでした。',
    'AI review sent as {0} review passes.': 'AI レビューを {0} 回のレビューパスとして送信しました。',
    'AI review: {0}': 'AI レビュー: {0}',
    'AI suggested change could not be added to the working draft: {0}': 'AI が提案した変更を作業ドラフトに追加できませんでした: {0}',
    'AI suggested change could not be linked to its review finding.': 'AI が提案した変更をレビューの指摘事項にリンクできませんでした。',
    'AI suggested change could not be staged in the working draft: {0}': 'AI が提案した変更を作業ドラフトにステージングできませんでした: {0}',
    'AI suggested change was staged but could not be marked ready: {0}': 'AI が提案した変更をステージングしましたが、準備完了にできませんでした: {0}',
    'Add at least one proposal operation before saving.': '保存する前に提案の操作を少なくとも 1 つ追加してください。',
    'Add challenge failed: {0}': 'チャレンジの追加に失敗しました: {0}',
    'Add failed: {0}': '追加に失敗しました: {0}',
    'Added ACP {0}': 'ACP {0} を追加しました',
    'Added category {0}.': 'カテゴリ {0} を追加しました。',
    'Added recommended terminology categories.': '推奨用語カテゴリを追加しました。',
    'Added term {0}.': '用語 {0} を追加しました。',
    'Added terminology package {0}.': '用語パッケージ {0} を追加しました。',
    'Added {0}': '{0} を追加しました',
    'Added {0} as context.': '{0} をコンテキストとして追加しました。',
    'Applied proposal {0}.': '提案 {0} を適用しました。',
    'Associated term with this element.': '用語をこの要素に関連付けました。',
    'Building proposal {0}. Use the GSN canvas and Save Proposal when ready.': '提案 {0} を作成中です。GSN キャンバスを使用し、準備ができたら「提案を保存」を選択してください。',
    'Category create failed: {0}': 'カテゴリの作成に失敗しました: {0}',
    'Category delete failed: {0}': 'カテゴリの削除に失敗しました: {0}',
    'Category not found.': 'カテゴリが見つかりません。',
    'Category update failed: {0}': 'カテゴリの更新に失敗しました: {0}',
    'Cleared the location of {0}': '{0} の場所をクリアしました',
    'Cleared the undeveloped decorator on {0}.': '{0} の未展開デコレーターを解除しました。',
    'Could not add review comment.': 'レビューコメントを追加できませんでした。',
    'Could not add term as context: {0}': '用語をコンテキストとして追加できませんでした: {0}',
    'Could not associate term with element: {0}': '用語を要素に関連付けられませんでした: {0}',
    'Could not create a TerminologyPackage for the new term.': '新しい用語用の TerminologyPackage を作成できませんでした。',
    'Could not decode terminology quick fix target.': '用語クイックフィックスの対象を解析できませんでした。',
    'Could not find a free GSN identifier for {0}.': '{0} に使用できる空き GSN 識別子が見つかりませんでした。',
    'Could not move the assessments into the SACM document: {0}': '評価を SACM ドキュメントに移動できませんでした: {0}',
    'Could not record the evidence location: {0}': 'エビデンスの場所を記録できませんでした: {0}',
    'Could not record the evidence {0}: {1}': 'エビデンスの {0} を記録できませんでした: {1}',
    'Could not resolve review comment.': 'レビューコメントを解決済みにできませんでした。',
    'Could not resolve selected element for proposal operation.': '提案操作の対象として選択された要素を特定できませんでした。',
    'Could not resolve selected element for proposal removal.': '提案の削除対象として選択された要素を特定できませんでした。',
    'Create confidence argument tree failed: {0}': '信頼度論証ツリーの作成に失敗しました: {0}',
    'Created a TerminologyPackage for new terms.': '新しい用語用の TerminologyPackage を作成しました。',
    'Created confidence argument tree {0} for {1}': '{1} の信頼度論証ツリー {0} を作成しました',
    'Deleted category.': 'カテゴリを削除しました。',
    'Deleted proposed change {0}.': '提案された変更 {0} を削除しました。',
    'Deleted review comment and proposed change.': 'レビューコメントと提案された変更を削除しました。',
    'Deleted review comment.': 'レビューコメントを削除しました。',
    'Deleted terminology package.': '用語パッケージを削除しました。',
    'Drop reference failed: {0}': '参照の削除に失敗しました: {0}',
    'Dropped the broken reference {0} from {1}.': '壊れた参照 {0} を {1} から削除しました。',
    'Dropped {0}, which left relationship {1} with nothing to relate, so it was removed too.': '{0} を削除しました。これにより関係 {1} の関連先がなくなったため、その関係も削除しました。',
    "Edit failed: unknown field '{0}'.": "編集に失敗しました: 不明なフィールド '{0}' です。",
    'Edit failed: {0}': '編集に失敗しました: {0}',
    'Editing proposal {0}. Use Save Proposal to update it.': '提案 {0} を編集中です。更新するには「提案を保存」を使用してください。',
    'Element marked OK manually.': '要素を手動で OK にしました。',
    'Enter a reviewer name before adding review comments.': 'レビューコメントを追加する前にレビュアー名を入力してください。',
    'Filtered glossary to duplicated term definition {0}.': '用語集を重複した用語定義 {0} で絞り込みました。',
    'Filtered the glossary for {0}. Select a term to link when occurrence binding is available.': '用語集を {0} で絞り込みました。出現箇所の紐付けが利用可能になったら、リンクする用語を選択してください。',
    'Find usages failed: {0}': '使用箇所の検索に失敗しました: {0}',
    'Ignored terminology list could not be loaded: could not open file.': '無視する用語リストを読み込めませんでした: ファイルを開けませんでした。',
    'Ignored terminology list could not be loaded: {0}': '無視する用語リストを読み込めませんでした: {0}',
    'Ignored terminology suggestion {0} for this session, but could not persist: {1}': '用語の提案 {0} をこのセッションでは無視しましたが、保存できませんでした: {1}',
    'Ignored terminology suggestion {0}.': '用語の提案 {0} を無視しました。',
    'Link failed: {0}': 'リンクに失敗しました: {0}',
    'Linked {0} to {1}': '{0} を {1} にリンクしました',
    'Load a SACM model before previewing proposals.': '提案をプレビューする前に SACM モデルを読み込んでください。',
    'Manual review OK cleared.': '手動レビューの OK を解除しました。',
    'Marked {0} undeveloped.': '{0} を未展開にしました。',
    'Move strategy failed: {0}': '戦略の移動に失敗しました: {0}',
    'Moved {0}': '{0} を移動しました',
    'Moved {0} into the reasoning of {1}.': '{0} を {1} の推論に移動しました。',
    'No active proposal draft for this review comment.': 'このレビューコメントには有効な提案の下書きがありません。',
    'No assurance case loaded.': '保証ケースが読み込まれていません。',
    'No broken reference selected.': '壊れた参照が選択されていません。',
    'No challenge target selected.': 'チャレンジの対象が選択されていません。',
    'No proposal id was provided.': '提案 ID が指定されていません。',
    'No strategy selected.': '戦略が選択されていません。',
    'Nothing to remove for this selection.': 'この選択には削除するものがありません。',
    'Open a SACM model before adding terminology context.': '用語のコンテキストを追加する前に SACM モデルを開いてください。',
    'Open a SACM model before associating terminology.': '用語を関連付ける前に SACM モデルを開いてください。',
    'Open a SACM model before defining terms.': '用語を定義する前に SACM モデルを開いてください。',
    'Open a SACM model before finding terminology usages.': '用語の使用箇所を検索する前に SACM モデルを開いてください。',
    'Open a SACM model before opening terminology terms.': '用語を開く前に SACM モデルを開いてください。',
    'Open a project and SACM file before applying proposed changes.': '提案された変更を適用する前にプロジェクトと SACM ファイルを開いてください。',
    'Open a project and SACM file before creating proposed changes.': '提案された変更を作成する前にプロジェクトと SACM ファイルを開いてください。',
    'Open a project and SACM file before editing proposed changes.': '提案された変更を編集する前にプロジェクトと SACM ファイルを開いてください。',
    'Open a project before deleting proposed changes.': '提案された変更を削除する前にプロジェクトを開いてください。',
    'Open a project before deleting review comments.': 'レビューコメントを削除する前にプロジェクトを開いてください。',
    'Open a project before resolving review comments.': 'レビューコメントを解決済みにする前にプロジェクトを開いてください。',
    'Open a project before saving proposals.': '提案を保存する前にプロジェクトを開いてください。',
    'Open a terminology package before adding categories.': 'カテゴリを追加する前に用語パッケージを開いてください。',
    'Open a terminology package before adding terms.': '用語を追加する前に用語パッケージを開いてください。',
    'Open confidence argument tree failed: ACP is not linked to a tree.': '信頼度論証ツリーを開けませんでした: ACP がツリーにリンクされていません。',
    'Open confidence argument tree failed: ACP was not found.': '信頼度論証ツリーを開けませんでした: ACP が見つかりません。',
    'Open or create a project before adding review comments.': 'レビューコメントを追加する前にプロジェクトを開くか作成してください。',
    'Opened term {0}.': '用語 {0} を開きました。',
    'Opened terminology term editor.': '用語エディターを開きました。',
    'Problem deleted.': '問題を削除しました。',
    'Problem resolved.': '問題を解決済みにしました。',
    'Proposal applied in memory, but proposal file removal failed: {0}': '提案をメモリ上で適用しましたが、提案ファイルの削除に失敗しました: {0}',
    'Proposal applied, but project save failed: {0}': '提案を適用しましたが、プロジェクトの保存に失敗しました: {0}',
    'Proposal applied, but review item update failed.': '提案を適用しましたが、レビュー項目の更新に失敗しました。',
    'Proposal applied, but the project is no longer open.': '提案を適用しましたが、プロジェクトはもう開いていません。',
    'Proposal apply failed: {0}': '提案の適用に失敗しました: {0}',
    'Proposal delete failed: {0}': '提案の削除に失敗しました: {0}',
    'Proposal deleted, but review link update failed.': '提案を削除しましたが、レビューのリンクの更新に失敗しました。',
    'Proposal draft preview failed: {0}': '提案の下書きのプレビューに失敗しました: {0}',
    'Proposal edit failed: the owning review comment no longer points to this proposal.': '提案の編集に失敗しました: 所属するレビューコメントがこの提案を参照しなくなっています。',
    'Proposal edit failed: the owning review comment was not found.': '提案の編集に失敗しました: 所属するレビューコメントが見つかりません。',
    'Proposal edit failed: the proposal belongs to a different review comment.': '提案の編集に失敗しました: この提案は別のレビューコメントに属しています。',
    'Proposal edit failed: {0}': '提案の編集に失敗しました: {0}',
    'Proposal is broken: {0}': '提案が壊れています: {0}',
    'Proposal link update failed.': '提案のリンクの更新に失敗しました。',
    'Proposal preview failed: {0}': '提案のプレビューに失敗しました: {0}',
    'Proposal save failed: {0}': '提案の保存に失敗しました: {0}',
    'Recommended terminology categories already exist.': '推奨用語カテゴリは既に存在します。',
    'Recorded proposal add operation.': '提案の追加操作を記録しました。',
    'Recorded proposal remove operation.': '提案の削除操作を記録しました。',
    'Recorded proposal top goal operation.': '提案のトップゴール操作を記録しました。',
    'Recorded the location of {0}': '{0} の場所を記録しました',
    'Recorded the {0} of {1}': '{1} の {0} を記録しました',
    'Remove ACP failed: {0}': 'ACP の削除に失敗しました: {0}',
    'Remove failed: {0}': '削除に失敗しました: {0}',
    'Remove relationship failed: {0}': '関係の削除に失敗しました: {0}',
    'Removed relationship {0}. Its elements were kept; any left unconnected show as orphans.': '関係 {0} を削除しました。要素は残してあり、接続がなくなった要素は孤立要素として表示されます。',
    'Removed {0}': '{0} を削除しました',
    'Renumber failed: {0}': '番号の振り直しに失敗しました: {0}',
    'Renumbered {0} to {1}.': '{0} を {1} に番号変更しました。',
    'Reordered {0}': '{0} を並べ替えました',
    'Resolved review comments cannot create proposed changes.': '解決済みのレビューコメントでは提案された変更を作成できません。',
    'Resolved review comments cannot edit proposed changes.': '解決済みのレビューコメントでは提案された変更を編集できません。',
    'Restored terminology suggestion {0} for this session, but could not persist: {1}': '用語の提案 {0} をこのセッションでは復元しましたが、保存できませんでした: {1}',
    'Restored terminology suggestion {0}.': '用語の提案 {0} を復元しました。',
    'Review comment added.': 'レビューコメントを追加しました。',
    'Review comment delete failed while deleting proposal: {0}': '提案の削除中にレビューコメントの削除に失敗しました: {0}',
    'Review comment is already resolved.': 'レビューコメントは既に解決済みです。',
    'Review comment resolved.': 'レビューコメントを解決済みにしました。',
    'Review comment was already removed.': 'レビューコメントは既に削除されています。',
    'SCCG guidelines are not available: {0}': 'SCCG ガイドラインを利用できません: {0}',
    'SCCG guidelines could not be loaded for AI review.': 'AI レビュー用の SCCG ガイドラインを読み込めませんでした。',
    'Save or discard the active proposal before adding more review comments.': 'レビューコメントをさらに追加する前に、作業中の提案を保存または破棄してください。',
    'Save or discard the active proposal before applying another proposal.': '別の提案を適用する前に、作業中の提案を保存または破棄してください。',
    'Save or discard the active proposal before creating another one.': '別の提案を作成する前に、作業中の提案を保存または破棄してください。',
    'Save or discard the active proposal before deleting another proposal.': '別の提案を削除する前に、作業中の提案を保存または破棄してください。',
    'Save or discard the active proposal before deleting review comments.': 'レビューコメントを削除する前に、作業中の提案を保存または破棄してください。',
    'Save or discard the active proposal before editing another one.': '別の提案を編集する前に、作業中の提案を保存または破棄してください。',
    'Save or discard the active proposal before resolving review comments.': 'レビューコメントを解決済みにする前に、作業中の提案を保存または破棄してください。',
    'Save or discard the active proposal before viewing another proposal.': '別の提案を表示する前に、作業中の提案を保存または破棄してください。',
    'Save the current SACM file before adding a terminology package.': '用語パッケージを追加する前に現在の SACM ファイルを保存してください。',
    'Saved proposal {0}.': '提案 {0} を保存しました。',
    'Select an element before adding a review comment.': 'レビューコメントを追加する前に要素を選択してください。',
    'Select an element before adding proposal nodes.': '提案ノードを追加する前に要素を選択してください。',
    'Select an element before removing proposal nodes.': '提案ノードを削除する前に要素を選択してください。',
    'Set undeveloped failed: {0}': '未展開の設定に失敗しました: {0}',
    'Start a proposal draft before editing proposal changes.': '提案の変更を編集する前に提案の下書きを開始してください。',
    'Term create failed: {0}': '用語の作成に失敗しました: {0}',
    'Term delete failed: {0}': '用語の削除に失敗しました: {0}',
    'Term is already associated with this element.': '用語は既にこの要素に関連付けられています。',
    'Term not found.': '用語が見つかりません。',
    'Term update failed: {0}': '用語の更新に失敗しました: {0}',
    'Terminology package create failed: {0}': '用語パッケージの作成に失敗しました: {0}',
    'Terminology package delete failed: the delete could not be completed.': '用語パッケージの削除に失敗しました: 削除を完了できませんでした。',
    'Terminology package delete failed: {0}': '用語パッケージの削除に失敗しました: {0}',
    'Terminology package update failed: {0}': '用語パッケージの更新に失敗しました: {0}',
    'Terminology quick fix target was not found.': '用語クイックフィックスの対象が見つかりません。',
    'The edited prompt no longer separates into its review passes; it will be sent as one request.': '編集したプロンプトはレビューパスに分割できなくなったため、1 つのリクエストとして送信されます。',
    'The reviewed element no longer exists in the loaded model.': 'レビュー対象の要素は読み込まれたモデルに存在しなくなりました。',
    'The selected usage has no navigable element id.': '選択した使用箇所には移動可能な要素 ID がありません。',
    'This review comment already has a proposed change.': 'このレビューコメントには既に提案された変更があります。',
    'This review comment has no proposed change to apply.': 'このレビューコメントには適用する提案された変更がありません。',
    'This review comment has no proposed change to delete.': 'このレビューコメントには削除する提案された変更がありません。',
    'This review comment has no proposed change to edit.': 'このレビューコメントには編集する提案された変更がありません。',
    'This review comment has no proposed change to preview.': 'このレビューコメントにはプレビューする提案された変更がありません。',
    'Tree move failed.': 'ツリーの移動に失敗しました。',
    'Tree move failed: {0}': 'ツリーの移動に失敗しました: {0}',
    'Unknown SCCG guideline id: {0}': '不明な SCCG ガイドライン ID: {0}',
...
PLURAL_TRANSLATIONS = {
    ...
    ('Found {0} usage of {1}.',
     'Found {0} usages of {1}.'):
        ['{1} の使用箇所が {0} 件見つかりました。'],
    ('Previewing proposal {0} with {1} operation. The project model has not been changed.',
     'Previewing proposal {0} with {1} operations. The project model has not been changed.'):
        ['提案 {0}（{1} 件の操作）をプレビュー中です。プロジェクトモデルは変更されていません。'],
    ('Removed {0} element',
     'Removed {0} elements'):
        ['{0} 件の要素を削除しました'],
}
