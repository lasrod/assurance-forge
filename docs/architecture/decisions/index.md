...
| [0006](0006-gsn-patterns-as-abstract-argument-packages.md) | GSN patterns persisted as abstract ArgumentPackages | Proposed |
| [0007](0007-single-gsn-canvas-with-editor-mode.md) | Single GSN canvas with an explicit editor mode | Proposed |
