...
Then Terminology Assist when you need to manage controlled vocabulary, define acronyms, resolve ambiguous term usage, or promote an important term into explicit argument context.
...
- [MCP Authoring Quality (planned)](mcp-authoring-quality-plan.md) — deliver SCCG authoring guidance through the channels that reach an agent even when the user's prompt says nothing about it
