...
|---|---|---|
| [SACM 2.3 conformance statement](sacm-conformance-statement.md) | Normative | The public claim: which compliance points, and how each release binds the claim to an evidence package. |
