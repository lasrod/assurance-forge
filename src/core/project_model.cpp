...
bool ProjectLoadReport::has_failures() const {
    for (const auto& step : steps) {
        if (step.status == ProjectLoadStepStatus::Failed)
            return true;
    }
    return false;
}
...
const char* ProjectFileRoleToString(ProjectFileRole role) {
    ...
    case ProjectFileRole::SacmArgument:
        return "sacm.argument";
    case ProjectFileRole::EvidenceRegister:
    ...
    case ProjectFileRole::ExportedReport:
        return "af.exportedReport";
    case ProjectFileRole::Unknown:
        return "unknown";
    }
    return "unknown";
}
...
ProjectFileRole ProjectFileRoleFromString(const std::string& value) {
    if (value == "sacm.argument")
        return ProjectFileRole::SacmArgument;
    if (value == "af.evidenceRegister")
    ...
    if (value == "af.exportedReport")
        return ProjectFileRole::ExportedReport;
    return ProjectFileRole::Unknown;
}

const char* ProjectFileStateToString(ProjectFileState state) {
    switch (state) {
    case ProjectFileState::Clean:
        return "clean";
    case ProjectFileState::ModifiedOutsideAssuranceForge:
        return "modifiedOutsideAssuranceForge";
    case ProjectFileState::ModifiedButCompatible:
        return "modifiedButCompatible";
    case ProjectFileState::ModifiedWithBrokenReferences:
        return "modifiedWithBrokenReferences";
    case ProjectFileState::Missing:
        return "missing";
    case ProjectFileState::Moved:
        return "moved";
    case ProjectFileState::ParseError:
        return "parseError";
    case ProjectFileState::UnsupportedVersion:
        return "unsupportedVersion";
    case ProjectFileState::GeneratedFileOutdated:
        return "generatedFileOutdated";
    }
    return "clean";
}
...
const char* ProjectFileStateToDisplayString(ProjectFileState state) {
    ...
    case ProjectFileState::Clean:
        return "Clean";
    case ProjectFileState::ModifiedOutsideAssuranceForge:
        return "Modified outside Assurance Forge";
    case ProjectFileState::ModifiedButCompatible:
        return "Modified but compatible";
    case ProjectFileState::ModifiedWithBrokenReferences:
        return "Modified with broken references";
    case ProjectFileState::Missing:
        return "Missing";
    case ProjectFileState::Moved:
        return "Moved";
    ...
    case ProjectFileState::GeneratedFileOutdated:
        return "Generated file outdated";
    }
    return "Clean";
}
