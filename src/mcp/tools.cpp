...
nlohmann::json OperationsSchema() {
    return nlohmann::json{
        ...
        {"description",
         ...
         "(\"text\" is the term EXACTLY as it is written in the argument -- \"EPB\", not \"EPB "
         "(Electronic Parking Brake)\", because a term is matched against element text by this string "
         "and a value that appears nowhere bounds nothing; the expansion goes in \"new_value\" with "
         "the rest of the definition; the containing terminology "
         "package is created if the case has none; the definition is required, because a term with no "
         "definition reads as defined and is not), UpdateTerm revises one field of it, RemoveTerm "
